...
public class APITest {
    ...
    public static String ALL_POSTS = PropertiesUtil.getEnvironment("environment.posts");
    public static String POST_99 = PropertiesUtil.getEnvironment("environment.post99");
    public static String POST_150 = PropertiesUtil.getEnvironment("environment.post150");
    public static String ALL_USERS = PropertiesUtil.getEnvironment("environment.users");
    public static String USER_5 = PropertiesUtil.getEnvironment("environment.user5");
    ...
    public void apiTest() throws IOException, InterruptedException {
        ...
        Assert.assertEquals(String.valueOf(response_1.statusCode()), "200");
        ...
        Assert.assertTrue(APIUtils.isPostsSortedByID(post_1, sortedById));
        ...
        Assert.assertEquals(String.valueOf(response_2.statusCode()), "200");
        Assert.assertEquals(post_2.getUserId().intValue(), 10);
        Assert.assertEquals(post_2.getId().intValue(), 99);
        Assert.assertFalse(post_2.getBody().isEmpty() && post_2.getTitle().isEmpty());

        //step 3
        HttpResponse<String> response_3 = APIUtils.getResponseFromGetRequest(POST_150);
        Assert.assertEquals(response_3.statusCode(), 404);
        Assert.assertEquals(response_3.body(), "{}");
        ...
        Assert.assertEquals(response_4.statusCode(), 201);
        ...
        Assert.assertEquals(response_5.statusCode(), 200);
        Assert.assertTrue(APIUtils.isJSONValid(response_5.body()));
        ...
        Assert.assertEquals(response_6.statusCode(), 200);
