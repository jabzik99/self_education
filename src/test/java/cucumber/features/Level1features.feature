Feature: Level1
  ...
  Scenario: TC - 2.1 - 2.2 Alerts + JS
    ...
    When I accept alert
    Then 'You successfuly clicked an alert' message is displayed in 'Result' section
