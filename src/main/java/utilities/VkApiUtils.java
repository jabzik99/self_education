...
public class VkApiUtils {
    private static final String HOST = PropertiesUtil.getVkTestData("vktestdata.url");
    private static final String TOKEN = PropertiesUtil.getVkTestData("vktestdata.token");
    private static final String VERSION = PropertiesUtil.getVkTestData("vktestdata.version");
    ...
    public static void postWallEdit(int postId, int mediaId, String message) {
        given()
                .baseUri(HOST)
    ...
    public static void wallAddComment(int postId, String message) {
        given()
                .baseUri(HOST)
